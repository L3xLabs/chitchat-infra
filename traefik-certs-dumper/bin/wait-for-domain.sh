...
/certs-dumper-bin/wait-for-file.sh /matrix/traefik-certs-dumper/dumped-certificates/$domain/certificate.crt 180 \
&& \
/certs-dumper-bin/wait-for-file.sh /matrix/traefik-certs-dumper/dumped-certificates/$domain/privatekey.key 180
